...
const cumulativeDefectRateData = [
  ...
  { type: '主机', device: 0.016, accessory: 0.112 },
];
...
const cumulativeDefectTrendData = {
  ...
  byDelivery: [
    ...
    { date: '2020-02', defectRate: 0.036, shipment: 0 },
...
export default [
  {
    url: '/basic-api/api/quality/charts/defect_age',
    method: 'get',
    response: () => {
      return resultSuccess(defectAgeData);
    },
  },
  {
    url: '/basic-api/api/quality/charts/cumulative_defect_rate',
    method: 'get',
    response: () => {
      return resultSuccess(cumulativeDefectRateData);
    },
  },
  {
    url: '/basic-api/api/quality/charts/cumulative_defect_trend',
    method: 'get',
    response: () => {
      return resultSuccess(cumulativeDefectTrendData);
    },
  },
  {
    url: '/basic-api/api/quality/charts/product_defect_trend',
    method: 'get',
    params: {
      model: 'RMN49-G321',
    },
    response: () => {
      return resultSuccess(productDefectTrendData);
    },
  },
] as MockMethod[];
